                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-16 px-4">
                        <div className="max-w-2xl">
                            <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight uppercase mb-4">Checkout <span className="text-blue-500">Gateway.</span></h1>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="flex flex-col items-center">
                                ...
                                <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest mt-3">Register</span>
                            </div>
                            ...
                            <div className="flex flex-col items-center opacity-20">
                                ...
                                <span className="text-[10px] font-bold text-white uppercase tracking-widest mt-3">Payment</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-4 order-2 lg:order-1">
                            <div className="bg-white/[0.02] backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-10 sticky top-32 shadow-2xl overflow-hidden">
                                ...
                                <div className="mb-10">
                                    <div className="text-blue-500 font-bold text-[10px] uppercase tracking-[0.2em] mb-4">Package Identity</div>
                                ...
                                <div className="space-y-6 mb-12">
                                    <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Selected Components:</div>
                                    <div className="space-y-4">
                                        {mandatoryItems.map(item => (
                                            <div key={item.id} className="flex justify-between items-center text-sm font-semibold text-slate-300">
                                                ...
                                                <span className="text-[10px] text-green-500 font-bold uppercase">Incl.</span>
                                            </div>
                                        ))}
                                ...
                                <div className="pt-8 border-t border-white/5 space-y-4">
                                    ...
                                    <div className="pt-6 border-t border-white/10 flex flex-col gap-2">
                                        <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Total Investment</span>
                                        ...
                                        <div className="flex items-center justify-between mb-12">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Authenticated School Profile</p>
                                                </div>
                                            </div>
                                            <span className="px-4 py-1.5 bg-green-500/10 text-green-500 border border-green-500/20 rounded-full text-xs font-bold uppercase tracking-widest">Verified</span>
                                        </div>
                                        ...
                                        <div className="space-y-8">
                                            <div>
                                                ...
                                                <div className="flex flex-col md:flex-row gap-4">
                                                    ...
                                                    >
                                                        {isChecking ? 'Processing...' : 'Verify Domain'}
                                                    </button>
                                                </div>
                                            </div>
