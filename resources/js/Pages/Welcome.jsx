        ...
        <div className="antialiased text-slate-900 bg-white selection:bg-blue-100 selection:text-blue-700 font-['Plus Jakarta Sans', sans-serif]">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    {mainBanner && (
                        <div className="text-center max-w-5xl mx-auto">
                            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-blue-300 text-[10px] font-bold uppercase tracking-widest mb-10 italic shadow-2xl shadow-blue-500/10">
                            ...
                            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[1.05] tracking-tight mb-8 italic drop-shadow-2xl">
                                {mainBanner.title} <br />
                            ...
                            <p className="text-lg md:text-xl text-slate-400 font-medium leading-relaxed mb-12 max-w-2xl mx-auto italic">
                                {mainBanner.subtitle}
                            </p>

                            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                                <Link href={mainBanner.button_link ?? route('register')} className="group relative w-full sm:w-auto px-8 py-4 bg-blue-600 rounded-2xl font-black text-sm text-white uppercase tracking-widest italic overflow-hidden shadow-[0_0_40px_-10px_rgba(37,99,235,0.5)] hover:shadow-[0_0_60px_-15px_rgba(37,99,235,0.7)] transition-all duration-300 hover:-translate-y-1 text-center">
                                ...
                                <a href="#katalog" className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 backdrop-blur-sm rounded-2xl font-bold text-sm text-white hover:bg-white/10 transition-all uppercase tracking-widest italic flex items-center justify-center gap-2">
                                    Eksplorasi Katalog
                                </a>
                            </div>
            ...
            <section className="py-12 bg-slate-50 border-b border-slate-200 overflow-hidden relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-6 text-center">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest italic">Dipercayai oleh Institusi & Bisnis Modern</p>
                </div>
                <div className="flex gap-12 w-max animate-marquee opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">ACME Corp</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">GlobalTech</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">EduSchool V</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">Nusantara Pos</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">Vertex AI</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">ACME Corp</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">GlobalTech</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">EduSchool V</div>
                    <div className="text-2xl font-black italic text-slate-800 shrink-0">Nusantara Pos</div>
            ...
            <section className="py-32 bg-slate-50 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-20 max-w-3xl mx-auto">
                        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight mb-6 italic">Infrastruktur Premium,<br /><span className="text-blue-600">Tanpa Batasan.</span></h2>
                        <p className="text-lg text-slate-500 font-medium italic">Kami menghadirkan standar teknologi kelas atas ke dalam sistem Anda, memastikan website berjalan cepat dan elegan.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
                        <div className="md:col-span-2 group relative bg-white rounded-[2rem] p-10 border border-slate-200 overflow-hidden hover:border-blue-300 transition-colors shadow-xl shadow-slate-200/50">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-black text-slate-900 mb-4 italic uppercase">Performa Kilat (Light-speed)</h3>
                                <p className="text-slate-500 font-medium leading-relaxed italic max-w-md">Dioptimasi hingga level kode terdalam. Kami menjamin kecepatan rendering halaman yang memukau, menurunkan bounce rate pelanggan Anda secara drastis.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 rounded-[2rem] p-10 border border-slate-800 text-white relative overflow-hidden group hover:bg-slate-800 transition-colors shadow-2xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-xl font-black mb-2 italic uppercase">Keamanan Solid</h3>
                                <p className="text-sm text-slate-400 italic">Enkripsi data berlapis & mitigasi vulnerability standar modern.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="katalog" className="py-32 bg-white border-t border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight mb-4 italic uppercase">Pilih Paket <span className="text-blue-600">Terbaik.</span></h2>
                        <div className="w-20 h-1.5 bg-blue-600 mx-auto rounded-full mb-6"></div>
                        <p className="text-lg text-slate-500 font-medium italic max-w-2xl mx-auto">Kami mengemas solusi yang rumit menjadi paket sederhana yang siap membantu transformasi Anda.</p>
                    </div>
            ...
            <section id="alur" className="py-32 bg-slate-950 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-24 max-w-3xl mx-auto">
                        <h2 className="text-4xl md:text-5xl font-black text-white tracking-tight mb-6 italic uppercase">Perjalanan Mudah Menuju <span className="bg-gradient-to-r from-blue-400 to-cyan-400 text-transparent bg-clip-text">Digitalisasi.</span></h2>
                        <p className="text-lg text-slate-400 font-medium italic">Empat langkah transparan tanpa prosedur rumit.</p>
                    </div>
                            ...
                            {steps.map((step, index) => (
                                <div key={index} className="relative text-center group">
                                    <div className={`w-24 h-24 mx-auto rounded-3xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-500 mb-8 relative transition-all duration-500 ${index < 2 ? 'border-blue-500/50 shadow-[0_0_30px_-5px_rgba(59,130,246,0.5)] text-blue-400 bg-slate-800/50' : 'group-hover:border-slate-600 group-hover:text-slate-300'}`}>
                                        <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-slate-950 border border-slate-800 flex items-center justify-center text-[10px] font-black italic">{step.step}</span>
                                    ...
                                    <h3 className="text-xl font-black text-white mb-3 italic uppercase">{step.title}</h3>
