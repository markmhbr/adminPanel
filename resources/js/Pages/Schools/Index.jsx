            ...
            header={
                <div className="flex flex-col md:flex-row justify-between items-center w-full gap-6">
                    <div className="text-center md:text-left">
                        <h2 className="text-3xl font-black leading-tight text-slate-900 uppercase tracking-tight">Project Schools</h2>
                        <p className="text-slate-400 font-bold text-xs mt-1 uppercase tracking-widest">Daftar instansi sekolah yang terintegrasi dengan sistem.</p>
                    </div>
                </div>
            }
        >
                        ...
                        {schools.data.map((school) => (
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col h-full">
                                    <div className="w-14 h-14 bg-indigo-600 rounded-2xl flex items-center justify-center text-white text-xl font-black shadow-lg shadow-indigo-200 mb-6 group-hover:rotate-6 transition-transform">
                                    ...
                                    <div className="mt-auto">
                                        <Link
                                            ...
                                            className="inline-flex items-center justify-center w-full h-12 bg-slate-900 hover:bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 gap-2"
                                        >
