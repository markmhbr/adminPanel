...
export default function Dashboard() {
    ...
    return (
        <AuthenticatedLayout
            user={auth?.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight uppercase">Admin Control Panel</h2>}
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                        ...
                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40">
                             <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Pesanan Baru</p>
                             <h3 className="text-3xl font-black text-indigo-600">12</h3>
                        </div>
                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40">
                             <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Customer Aktif</p>
                             <h3 className="text-3xl font-black text-slate-900">156</h3>
                        </div>
                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40">
                             <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Pendapatan (Bln ini)</p>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-6">
                            <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white relative overflow-hidden group">
                                <div className="relative z-10">
                                    <h2 className="text-3xl font-black uppercase mb-4">Selamat Datang, Admin!</h2>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/40 p-8">
                                <h4 className="text-sm font-black text-slate-900 mb-6 uppercase tracking-widest">Akses Cepat</h4>
                                <div className="space-y-4">
                                    <Link href={route('admin.hero.index')} className="flex items-center gap-4 p-4 hover:bg-slate-50 rounded-2xl transition-all group">
                                        ...
                                        <span className="text-xs font-black text-slate-600 uppercase tracking-widest">Hero Banners</span>
                                    </Link>
                                    <Link href={route('admin.profile.store')} className="flex items-center gap-4 p-4 hover:bg-slate-50 rounded-2xl transition-all group">
                                        ...
                                        <span className="text-xs font-black text-slate-600 uppercase tracking-widest">Store Settings</span>
                                    </Link>
                                </div>
                            </div>
                        </div>
