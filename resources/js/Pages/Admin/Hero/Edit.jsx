...
export default function Edit({ auth, banner }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Hero Banner</h2>}
        >
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-4">
                                ...
                                <select 
                                    ...
                                    className="w-full px-4 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-600 transition-all font-bold appearance-none"
                                >
