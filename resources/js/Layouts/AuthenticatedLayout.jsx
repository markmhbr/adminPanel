                                        ...
                                        <>
                                            ...
                                            >
                                                ...
                                                <div className="space-y-1">
                                                    <Link href={route('admin.store-profile.edit')} className="flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold italic uppercase tracking-wide transition-all hover:bg-indigo-50 text-slate-600 hover:text-indigo-600">
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                                        Profil Perusahaan
                                                    </Link>
                                                    <Link href={route('admin.profile.edit')} className="flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold italic uppercase tracking-wide transition-all hover:bg-indigo-50 text-slate-600 hover:text-indigo-600">
